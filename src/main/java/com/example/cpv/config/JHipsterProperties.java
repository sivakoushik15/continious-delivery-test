package com.example.cpv.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "cpv@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "cpv API";

        private String description = "cpv API documentation";
